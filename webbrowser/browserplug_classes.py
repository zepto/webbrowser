...
class BrowserView(gtk.HPaned):
    ...
    def _settings_item(self):
        ...
        menu_item_tup = (
                ...
                ('Enable _WebGL', True, 
                    self.get_browser_setting('enable-webgl'), 
                    (self._toggle_setting, 'enable-webgl')),
                ('Enable _Universal Access from File Uris', True, 
                    self.get_browser_setting('enable-universal-access-from-file-uris'), 
                    (self._toggle_setting, 'enable-universal-access-from-file-uris')),
